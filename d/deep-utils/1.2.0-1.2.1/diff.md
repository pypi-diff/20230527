# Comparing `tmp/deep_utils-1.2.0.tar.gz` & `tmp/deep_utils-1.2.1.tar.gz`
...
### Comparing `deep_utils-1.2.0/LICENSE` & `deep_utils-1.2.1/LICENSE`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/PKG-INFO` & `deep_utils-1.2.1/PKG-INFO`
...
+Or check the following full sample [easy_image_editing](https://github.com/
+pooya-mohammadi/easy_image_editing) ## NLP In this section, models and
+utilities for nlp projects are provided ### NER Name Entity Recognition ####
+multi-label-stratify ## Augmentation ### CutMix [Open_In_Colab] CutMix is one
+of the best augmentation methods that's proven to be very effective in
+different vision-based project. Therefore, CutMix is now available on
+`deep_utils` to be used both for segmentation and classification tasks.Let some
+examples: #### Segmentation ```python import cv2 import numpy as np from
+deep_utils import CutMixTF, group_show, repeat_dimension # creating random
+images, the code for this section can be found in the colab notebook image_a =
+np.zeros((300, 300, 3), np.uint8) * 255 mask_a = np.zeros_like(image_a) pt1 =
+(150, 100) pt2 = (100, 200) pt3 = (200, 200) triangle_cnt = np.array([pt1, pt2,
+pt3]) image_a = cv2.drawContours(image_a, [triangle_cnt], 0, (0, 255, 0), -1)
+mask_a = cv2.drawContours(mask_a, [triangle_cnt], 0, (255, 255, 255), -1)
+image_b = np.zeros((300, 300, 3), np.uint8) * 255 mask_b = np.zeros_like
+(image_b) pt1 = (150, 150) image_b = cv2.circle(image_b, pt1, 50, (0, 255, 0),
+-1) mask_b = cv2.circle(mask_b, pt1, 50, (255, 255, 255), -1) # CutMix for two
+individual images: cutmix_img, cutmix_mask = CutMixTF.seg_cutmix(image_a,
+mask_a[..., 0], image_b, mask_b[..., 0], beta=1) ``` The input and output are
+as follows: **Input:** [Logo]
...
### Comparing `deep_utils-1.2.0/deep_utils/__init__.py` & `deep_utils-1.2.1/deep_utils/__init__.py`
...
### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/cv2_dummy.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/cv2_dummy.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/dummy_framework/dummy_framework.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/dummy_framework/dummy_framework.py`
...
### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/glide_text2im_dummy.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/glide_text2im_dummy.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/groundingdino_torch_dummy.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/groundingdino_torch_dummy.py`
...
### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/torch_cv2_dummy.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/torch_cv2_dummy.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/torch_dummy.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/torch_dummy.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/torchvision_torch_timm_transformers_fairscale_dummy.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/torchvision_torch_timm_transformers_fairscale_dummy.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/utils/sqlalchemy_utils/__init__.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/utils/sqlalchemy_utils/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/vision/face_detection/__init__.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/vision/face_detection/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/vision/object_detection/__init__.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/vision/object_detection/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/_dummy_objects/vision/object_tracker/__init__.py` & `deep_utils-1.2.1/deep_utils/_dummy_objects/vision/object_tracker/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/audio/asr/wav2vec2/torch/main.py` & `deep_utils-1.2.1/deep_utils/audio/asr/wav2vec2/torch/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/audio/audio_utils/librosa_utils.py` & `deep_utils-1.2.1/deep_utils/audio/audio_utils/librosa_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/audio/audio_utils/torchaudio_utils.py` & `deep_utils-1.2.1/deep_utils/audio/audio_utils/torchaudio_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/audio/audio_utils/vox_utils.py` & `deep_utils-1.2.1/deep_utils/audio/audio_utils/vox_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/audio/classification/wav2vec2/torch/audio_classification_wav2vec2.py` & `deep_utils-1.2.1/deep_utils/audio/classification/wav2vec2/torch/audio_classification_wav2vec2.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/audio/diarization/pyannote/pyannote_audio_diarization.py` & `deep_utils-1.2.1/deep_utils/audio/diarization/pyannote/pyannote_audio_diarization.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/audio/vad/pyannote/pyannote_audio_vad.py` & `deep_utils-1.2.1/deep_utils/audio/vad/pyannote/pyannote_audio_vad.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/augmentation/cutmix/cutmix_tf.py` & `deep_utils-1.2.1/deep_utils/augmentation/cutmix/cutmix_tf.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/augmentation/cutmix/cutmix_torch.py` & `deep_utils-1.2.1/deep_utils/augmentation/cutmix/cutmix_torch.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/augmentation/torch/augmentation_torch.py` & `deep_utils-1.2.1/deep_utils/augmentation/torch/augmentation_torch.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/blocks/tf/blocks_tf.py` & `deep_utils-1.2.1/deep_utils/blocks/tf/blocks_tf.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/blocks/torch/blocks_torch.py` & `deep_utils-1.2.1/deep_utils/blocks/torch/blocks_torch.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/callbacks/tf_keras/lr.py` & `deep_utils-1.2.1/deep_utils/callbacks/tf_keras/lr.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/callbacks/torch/torch_csv_logger.py` & `deep_utils-1.2.1/deep_utils/callbacks/torch/torch_csv_logger.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/callbacks/torch/torch_model_checkpoint.py` & `deep_utils-1.2.1/deep_utils/callbacks/torch/torch_model_checkpoint.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/callbacks/torch/torch_tensorboard.py` & `deep_utils-1.2.1/deep_utils/callbacks/torch/torch_tensorboard.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/design_patterns/chain_of_responsibility/chain_of_responsibilities_handlers.py` & `deep_utils-1.2.1/deep_utils/design_patterns/chain_of_responsibility/chain_of_responsibilities_handlers.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/elasticsearch/search_engine/elasticsearch_search_engine.py` & `deep_utils-1.2.1/deep_utils/elasticsearch/search_engine/elasticsearch_search_engine.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/gis/projection/main.py` & `deep_utils-1.2.1/deep_utils/gis/projection/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/main_abs/cv2/cv2_caffe.py` & `deep_utils-1.2.1/deep_utils/main_abs/cv2/cv2_caffe.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/main_abs/cv2/cv2_main.py` & `deep_utils-1.2.1/deep_utils/main_abs/cv2/cv2_main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/main_abs/main.py` & `deep_utils-1.2.1/deep_utils/main_abs/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/main_abs/main_config.py` & `deep_utils-1.2.1/deep_utils/main_abs/main_config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/multi_modals/_models/blip/torch/models/blip.py` & `deep_utils-1.2.1/deep_utils/multi_modals/_models/blip/torch/models/blip.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/multi_modals/_models/blip/torch/models/med.py` & `deep_utils-1.2.1/deep_utils/multi_modals/_models/blip/torch/models/med.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/multi_modals/_models/blip/torch/models/med_configs.py` & `deep_utils-1.2.1/deep_utils/multi_modals/_models/blip/torch/models/med_configs.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/multi_modals/_models/blip/torch/models/vit.py` & `deep_utils-1.2.1/deep_utils/multi_modals/_models/blip/torch/models/vit.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/nlp/ner/augmentation.py` & `deep_utils-1.2.1/deep_utils/nlp/ner/augmentation.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/nlp/ner/base_operations.py` & `deep_utils-1.2.1/deep_utils/nlp/ner/base_operations.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/nlp/ner/preprocessing.py` & `deep_utils-1.2.1/deep_utils/nlp/ner/preprocessing.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/nlp/ner/utils_.py` & `deep_utils-1.2.1/deep_utils/nlp/ner/utils_.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/nlp/utils/persian/utils.py` & `deep_utils-1.2.1/deep_utils/nlp/utils/persian/utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/preprocessing/monai/monai_segmentation.py` & `deep_utils-1.2.1/deep_utils/preprocessing/monai/monai_segmentation.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/__init__.py` & `deep_utils-1.2.1/deep_utils/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/algorithm_utils/main.py` & `deep_utils-1.2.1/deep_utils/utils/algorithm_utils/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/box_utils/boxes.py` & `deep_utils-1.2.1/deep_utils/utils/box_utils/boxes.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/coco_utils/main.py` & `deep_utils-1.2.1/deep_utils/utils/coco_utils/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/color_utils/color_utils.py` & `deep_utils-1.2.1/deep_utils/utils/color_utils/color_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/compress_utils/zip_utils.py` & `deep_utils-1.2.1/deep_utils/utils/compress_utils/zip_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/ctc_decoder/ctc_decoder.py` & `deep_utils-1.2.1/deep_utils/utils/ctc_decoder/ctc_decoder.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/decorators/main.py` & `deep_utils-1.2.1/deep_utils/utils/decorators/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/dict_named_tuple_utils/dictnamedtuple_37.py` & `deep_utils-1.2.1/deep_utils/utils/dict_named_tuple_utils/dictnamedtuple_37.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/dict_named_tuple_utils/dictnamedtuple_38.py` & `deep_utils-1.2.1/deep_utils/utils/dict_named_tuple_utils/dictnamedtuple_38.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/dict_utils/dict_utils.py` & `deep_utils-1.2.1/deep_utils/utils/dict_utils/dict_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/dir_utils/dir_utils.py` & `deep_utils-1.2.1/deep_utils/utils/dir_utils/dir_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/download_utils/download_utils.py` & `deep_utils-1.2.1/deep_utils/utils/download_utils/download_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/encodes/b64.py` & `deep_utils-1.2.1/deep_utils/utils/encodes/b64.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/gif_utils/gif_utils.py` & `deep_utils-1.2.1/deep_utils/utils/gif_utils/gif_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/hash_utils/hash_utils.py` & `deep_utils-1.2.1/deep_utils/utils/hash_utils/hash_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/image_utils/image_utils.py` & `deep_utils-1.2.1/deep_utils/utils/image_utils/image_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/json_utils/json_utils.py` & `deep_utils-1.2.1/deep_utils/utils/json_utils/json_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/kafka_utils/kafka_utils.py` & `deep_utils-1.2.1/deep_utils/utils/kafka_utils/kafka_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/lib_utils/download_utils.py` & `deep_utils-1.2.1/deep_utils/utils/lib_utils/download_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/lib_utils/lib_decorators.py` & `deep_utils-1.2.1/deep_utils/utils/lib_utils/lib_decorators.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/lib_utils/main_utils.py` & `deep_utils-1.2.1/deep_utils/utils/lib_utils/main_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/logging_utils/logging_utils.py` & `deep_utils-1.2.1/deep_utils/utils/logging_utils/logging_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/lr_scheduler_utils/warmup.py` & `deep_utils-1.2.1/deep_utils/utils/lr_scheduler_utils/warmup.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/matplotlib_utils/bar_plots.py` & `deep_utils-1.2.1/deep_utils/utils/matplotlib_utils/bar_plots.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/matplotlib_utils/main.py` & `deep_utils-1.2.1/deep_utils/utils/matplotlib_utils/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/memory_utils/torch_memory_utils.py` & `deep_utils-1.2.1/deep_utils/utils/memory_utils/torch_memory_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/minio_lib/main.py` & `deep_utils-1.2.1/deep_utils/utils/minio_lib/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/multi_label_utils/stratify/stratify_train_test_split.py` & `deep_utils-1.2.1/deep_utils/utils/multi_label_utils/stratify/stratify_train_test_split.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/np_utils/main_np.py` & `deep_utils-1.2.1/deep_utils/utils/np_utils/main_np.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/object_utils/object_utils.py` & `deep_utils-1.2.1/deep_utils/utils/object_utils/object_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/opencv_utils/opencv_utils.py` & `deep_utils-1.2.1/deep_utils/utils/opencv_utils/opencv_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/optimizers/tf.py` & `deep_utils-1.2.1/deep_utils/utils/optimizers/tf.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/os_utils/os_path.py` & `deep_utils-1.2.1/deep_utils/utils/os_utils/os_path.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/postgresql_utils/postgresql_utils.py` & `deep_utils-1.2.1/deep_utils/utils/postgresql_utils/postgresql_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/re_utils/re_utils.py` & `deep_utils-1.2.1/deep_utils/utils/re_utils/re_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/requests_utils/requests_utils.py` & `deep_utils-1.2.1/deep_utils/utils/requests_utils/requests_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/resize_utils/main_resize.py` & `deep_utils-1.2.1/deep_utils/utils/resize_utils/main_resize.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/shutil_utils/shutil_utils.py` & `deep_utils-1.2.1/deep_utils/utils/shutil_utils/shutil_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/sqlalchemy/__init__.py` & `deep_utils-1.2.1/deep_utils/utils/sqlalchemy/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/sqlalchemy/checks.py` & `deep_utils-1.2.1/deep_utils/utils/sqlalchemy/checks.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/sqlalchemy/sqlalchemy_utils.py` & `deep_utils-1.2.1/deep_utils/utils/sqlalchemy/sqlalchemy_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/tensorboard_utils/tesnsorboard_utils.py` & `deep_utils-1.2.1/deep_utils/utils/tensorboard_utils/tesnsorboard_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/tf_utils/logging.py` & `deep_utils-1.2.1/deep_utils/utils/tf_utils/logging.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/tf_utils/main.py` & `deep_utils-1.2.1/deep_utils/utils/tf_utils/main.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/torch_utils/torch_utils.py` & `deep_utils-1.2.1/deep_utils/utils/torch_utils/torch_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/utils/hyper_parameters.py` & `deep_utils-1.2.1/deep_utils/utils/utils/hyper_parameters.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/utils/shuffle_utils.py` & `deep_utils-1.2.1/deep_utils/utils/utils/shuffle_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/utils/str_utils.py` & `deep_utils-1.2.1/deep_utils/utils/utils/str_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/utils/utils/yaml_utils.py` & `deep_utils-1.2.1/deep_utils/utils/utils/yaml_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/color_recognition/cnn_color/torch/color_cnn_torch.py` & `deep_utils-1.2.1/deep_utils/vision/color_recognition/cnn_color/torch/color_cnn_torch.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/color_recognition/cnn_color/torch/color_cnn_torch_pred.py` & `deep_utils-1.2.1/deep_utils/vision/color_recognition/cnn_color/torch/color_cnn_torch_pred.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/__init__.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/haarcascade/cv2_/config.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/haarcascade/cv2_/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/haarcascade/cv2_/haarcascade_cv2_face_detection.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/haarcascade/cv2_/haarcascade_cv2_face_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/main/main_face_detection.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/main/main_face_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/tf/config.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/tf/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/tf/mtcnn_tf_face_detection.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/tf/mtcnn_tf_face_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/tf/src/box_utils.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/tf/src/box_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/tf/src/first_stage.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/tf/src/first_stage.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/tf/src/get_nets.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/tf/src/get_nets.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/torch/config.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/torch/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/torch/mtcnn_torch_face_detection.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/torch/mtcnn_torch_face_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/torch/src/box_utils.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/torch/src/box_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/torch/src/first_stage.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/torch/src/first_stage.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/mtcnn/torch/src/get_nets.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/mtcnn/torch/src/get_nets.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/config.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/retinaface_torch_face_detection.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/retinaface_torch_face_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/src/layers/functions/prior_box.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/src/layers/functions/prior_box.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/src/layers/modules/multibox_loss.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/src/layers/modules/multibox_loss.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/src/load_model.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/src/load_model.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/src/net.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/src/net.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/src/retinaface.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/src/retinaface.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/src/utils/box_utils.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/src/utils/box_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/src/utils/nms/py_cpu_nms.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/src/utils/nms/py_cpu_nms.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/retinaface/torch/src/utils/timer.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/retinaface/torch/src/utils/timer.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ssd/cv2/caffe/config.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ssd/cv2/caffe/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ssd/cv2/caffe/ssd_cv2_caffe_face_detection.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ssd/cv2/caffe/ssd_cv2_caffe_face_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/tf/ultralight_tf_face_detection.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/tf/ultralight_tf_face_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/tf/utils/op.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/tf/utils/op.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/tf/utils/rfb_320.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/tf/utils/rfb_320.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/tf/utils/slim_320.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/tf/utils/slim_320.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/tf/utils/utils.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/tf/utils/utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/config.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/ultralight_torch_face_detection.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/ultralight_torch_face_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/box_utils.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/box_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/data_preprocessing.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/data_preprocessing.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/fd_config.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/fd_config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/mb_tiny.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/mb_tiny.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/mb_tiny_RFB.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/mb_tiny_RFB.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/mb_tiny_RFB_fd.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/mb_tiny_RFB_fd.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/mb_tiny_fd.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/mb_tiny_fd.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/misc.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/misc.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/predictor.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/predictor.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/ssd.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/ssd.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_detection/ultralight/torch/utils/transforms.py` & `deep_utils-1.2.1/deep_utils/vision/face_detection/ultralight/torch/utils/transforms.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_recognition/main/main_face_recognition.py` & `deep_utils-1.2.1/deep_utils/vision/face_recognition/main/main_face_recognition.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_recognition/vggface2/torch/config.py` & `deep_utils-1.2.1/deep_utils/vision/face_recognition/vggface2/torch/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_recognition/vggface2/torch/src/senet_model.py` & `deep_utils-1.2.1/deep_utils/vision/face_recognition/vggface2/torch/src/senet_model.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/face_recognition/vggface2/torch/vggface2_torch.py` & `deep_utils-1.2.1/deep_utils/vision/face_recognition/vggface2/torch/vggface2_torch.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/image_caption/blip/torch/blip_torch_image_caption.py` & `deep_utils-1.2.1/deep_utils/vision/image_caption/blip/torch/blip_torch_image_caption.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/image_caption/image_caption.py` & `deep_utils-1.2.1/deep_utils/vision/image_caption/image_caption.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/image_editing/glide/glide_image_editing.py` & `deep_utils-1.2.1/deep_utils/vision/image_editing/glide/glide_image_editing.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/__init__.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/main/main_object_detection.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/main/main_object_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/config.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/models/common.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/models/common.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/models/experimental.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/models/experimental.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/models/tf.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/models/tf.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/models/yolo.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/models/yolo.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolo_v5_torch_object_detection.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolo_v5_torch_object_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/__init__.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/activations.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/activations.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/augmentations.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/augmentations.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/autoanchor.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/autoanchor.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/autobatch.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/autobatch.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/callbacks.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/callbacks.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/dataloaders.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/dataloaders.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/datasets.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/datasets.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/downloads.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/downloads.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/general.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/general.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/google_utils.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/google_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/loss.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/loss.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/metrics.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/metrics.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/plots.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/plots.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/augmentations.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/augmentations.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/dataloaders.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/dataloaders.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/general.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/general.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/loss.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/loss.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/metrics.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/metrics.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/plots.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/segment/plots.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/torch_utils.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/torch_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/triton.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v5/torch/yolov5_utils/triton.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/config.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/config.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/models/common.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/models/common.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/models/experimental.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/models/experimental.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/models/yolo.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/models/yolo.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolo_v7_torch_object_detection.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolo_v7_torch_object_detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/activations.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/activations.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/add_nms.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/add_nms.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/autoanchor.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/autoanchor.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/datasets.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/datasets.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/general.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/general.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/google_utils.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/google_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/loss.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/loss.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/metrics.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/metrics.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/plots.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/plots.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/torch_utils.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/v7/torch/yolov7_utils/torch_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_detection/yolo/yolo_detector.py` & `deep_utils-1.2.1/deep_utils/vision/object_detection/yolo/yolo_detector.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/__init__.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/__init__.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/__init__.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/deep_sort.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/deep_sort.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/sort/detection.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/sort/detection.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/sort/iou_matching.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/sort/iou_matching.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/sort/kalman_filter.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/sort/kalman_filter.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/sort/linear_assignment.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/sort/linear_assignment.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/sort/nn_matching.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/sort/nn_matching.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/sort/preprocessing.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/sort/preprocessing.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/sort/track.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/sort/track.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/sort/tracker.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/sort/tracker.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/utils/draw.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/utils/draw.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/utils/evaluation.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/utils/evaluation.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/utils/io.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/utils/io.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/utils/json_logger.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/utils/json_logger.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/utils/parser.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/utils/parser.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/object_tracker/deep_sort/torch/utils/tools.py` & `deep_utils-1.2.1/deep_utils/vision/object_tracker/deep_sort/torch/utils/tools.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/ocr/crnn/torch/crnn_inference.py` & `deep_utils-1.2.1/deep_utils/vision/ocr/crnn/torch/crnn_inference.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/ocr/crnn/torch/crnn_model.py` & `deep_utils-1.2.1/deep_utils/vision/ocr/crnn/torch/crnn_model.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/text2box_visual_grounding/dino/visual_grounding_dino_torch.py` & `deep_utils-1.2.1/deep_utils/vision/text2box_visual_grounding/dino/visual_grounding_dino_torch.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/torch_vision/torch_vision_inference/torch_vision_inference.py` & `deep_utils-1.2.1/deep_utils/vision/torch_vision/torch_vision_inference/torch_vision_inference.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/torch_vision/torch_vision_models/torch_vision_models.py` & `deep_utils-1.2.1/deep_utils/vision/torch_vision/torch_vision_models/torch_vision_models.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils/vision/vision_utils/torch_vision_utils/torch_vision_utils.py` & `deep_utils-1.2.1/deep_utils/vision/vision_utils/torch_vision_utils/torch_vision_utils.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/deep_utils.egg-info/PKG-INFO` & `deep_utils-1.2.1/deep_utils.egg-info/PKG-INFO`
...
### Comparing `deep_utils-1.2.0/deep_utils.egg-info/SOURCES.txt` & `deep_utils-1.2.1/deep_utils.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/setup.py` & `deep_utils-1.2.1/setup.py`
...
### Comparing `deep_utils-1.2.0/tests/utils/encoding_utils/encoding_utils_test.py` & `deep_utils-1.2.1/tests/utils/encoding_utils/encoding_utils_test.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/tests/utils/np_utils/np_utils_test.py` & `deep_utils-1.2.1/tests/utils/np_utils/np_utils_test.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/tests/utils/resize_utils/resize_utils_test.py` & `deep_utils-1.2.1/tests/utils/resize_utils/resize_utils_test.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/tests/vision/face_detection/mtcnn/torch/mtcnn_torch_test.py` & `deep_utils-1.2.1/tests/vision/face_detection/mtcnn/torch/mtcnn_torch_test.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/tests/vision/face_detection/ultralight/torch/ultralight_torch_test.py` & `deep_utils-1.2.1/tests/vision/face_detection/ultralight/torch/ultralight_torch_test.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/tests/vision/object_detection/yolo/v5/torch/yolov5_detection_test.py` & `deep_utils-1.2.1/tests/vision/object_detection/yolo/v5/torch/yolov5_detection_test.py`

 * *Files identical despite different names*

### Comparing `deep_utils-1.2.0/tests/vision/vision_utils/torch_vision_utils/torch_vision_utils_test.py` & `deep_utils-1.2.1/tests/vision/vision_utils/torch_vision_utils/torch_vision_utils_test.py`

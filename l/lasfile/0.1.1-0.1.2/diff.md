# Comparing `tmp/lasfile-0.1.1.tar.gz` & `tmp/lasfile-0.1.2.tar.gz`
...
## Comparing `lasfile-0.1.1.tar` & `lasfile-0.1.2.tar`
...
### Comparing `lasfile-0.1.1/LICENSE` & `lasfile-0.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `lasfile-0.1.1/PKG-INFO` & `lasfile-0.1.2/PKG-INFO`
...
### Comparing `lasfile-0.1.1/src/known_sections.json` & `lasfile-0.1.2/src/known_sections.json`

 * *Files identical despite different names*

### Comparing `lasfile-0.1.1/src/lasfile.egg-info/PKG-INFO` & `lasfile-0.1.2/src/lasfile.egg-info/PKG-INFO`
...
### Comparing `lasfile-0.1.1/src/lasfile.py` & `lasfile-0.1.2/src/lasfile.py`

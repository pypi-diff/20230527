# Comparing `tmp/lifetimefitting-0.0.15.tar.gz` & `tmp/lifetimefitting-0.0.16.tar.gz`
...
+gzip compressed data, was "lifetimefitting-0.0.16.tar", last modified: Sat May 27 03:11:56 2023, max compression
```

## Comparing `lifetimefitting-0.0.15.tar` & `lifetimefitting-0.0.16.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-27 03:11:56.144245 lifetimefitting-0.0.16/
+-rw-r--r--   0 runner    (1001) docker     (123)     1062 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/LICENSE.md
+-rw-r--r--   0 runner    (1001) docker     (123)     2646 2023-05-27 03:11:56.144245 lifetimefitting-0.0.16/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     2171 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-27 03:11:56.144245 lifetimefitting-0.0.16/app/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-27 03:11:56.144245 lifetimefitting-0.0.16/app/lifetimefitting/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/app/lifetimefitting/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     3063 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/app/lifetimefitting/__main__.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-27 03:11:56.144245 lifetimefitting-0.0.16/app/lifetimefitting/funcs/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/app/lifetimefitting/funcs/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2013 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/app/lifetimefitting/funcs/expFuncs.py
+-rw-r--r--   0 runner    (1001) docker     (123)     7089 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/app/lifetimefitting/funcs/fittingFuncs.py
+-rw-r--r--   0 runner    (1001) docker     (123)    12992 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/app/lifetimefitting/funcs/gui.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-27 03:11:56.144245 lifetimefitting-0.0.16/app/lifetimefitting.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     2646 2023-05-27 03:11:56.000000 lifetimefitting-0.0.16/app/lifetimefitting.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      458 2023-05-27 03:11:56.000000 lifetimefitting-0.0.16/app/lifetimefitting.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-27 03:11:56.000000 lifetimefitting-0.0.16/app/lifetimefitting.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       61 2023-05-27 03:11:56.000000 lifetimefitting-0.0.16/app/lifetimefitting.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       16 2023-05-27 03:11:56.000000 lifetimefitting-0.0.16/app/lifetimefitting.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-27 03:11:56.144245 lifetimefitting-0.0.16/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)      882 2023-05-27 03:11:45.000000 lifetimefitting-0.0.16/setup.py
```

### Comparing `lifetimefitting-0.0.15/LICENSE.md` & `lifetimefitting-0.0.16/LICENSE.md`

 * *Files identical despite different names*

### Comparing `lifetimefitting-0.0.15/PKG-INFO` & `lifetimefitting-0.0.16/PKG-INFO`
...
### Comparing `lifetimefitting-0.0.15/README.md` & `lifetimefitting-0.0.16/README.md`

 * *Files identical despite different names*

### Comparing `lifetimefitting-0.0.15/app/lifetimefitting/funcs.py` & `lifetimefitting-0.0.16/app/lifetimefitting/funcs/expFuncs.py`
...
### Comparing `lifetimefitting-0.0.15/app/lifetimefitting/gui.py` & `lifetimefitting-0.0.16/app/lifetimefitting/funcs/gui.py`
...
### Comparing `lifetimefitting-0.0.15/app/lifetimefitting.egg-info/PKG-INFO` & `lifetimefitting-0.0.16/app/lifetimefitting.egg-info/PKG-INFO`
...
### Comparing `lifetimefitting-0.0.15/setup.py` & `lifetimefitting-0.0.16/setup.py`

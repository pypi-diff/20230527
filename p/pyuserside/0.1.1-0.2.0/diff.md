# Comparing `tmp/pyuserside-0.1.1.tar.gz` & `tmp/pyuserside-0.2.0.tar.gz`
...
## Comparing `pyuserside-0.1.1.tar` & `pyuserside-0.2.0.tar`
...
### Comparing `pyuserside-0.1.1/LICENSE` & `pyuserside-0.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `pyuserside-0.1.1/PKG-INFO` & `pyuserside-0.2.0/PKG-INFO`
...
### Comparing `pyuserside-0.1.1/pyproject.toml` & `pyuserside-0.2.0/pyproject.toml`
...
### Comparing `pyuserside-0.1.1/src/pyuserside.egg-info/PKG-INFO` & `pyuserside-0.2.0/src/pyuserside.egg-info/PKG-INFO`

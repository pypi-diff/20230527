# Comparing `tmp/torchlayers-nightly-1684973248.tar.gz` & `tmp/torchlayers-nightly-1685059622.tar.gz`
...
## Comparing `torchlayers-nightly-1684973248.tar` & `torchlayers-nightly-1685059622.tar`
...
### Comparing `torchlayers-nightly-1684973248/PKG-INFO` & `torchlayers-nightly-1685059622/PKG-INFO`
...
### Comparing `torchlayers-nightly-1684973248/README.md` & `torchlayers-nightly-1685059622/README.md`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/setup.py` & `torchlayers-nightly-1685059622/setup.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/tests/convolution_test.py` & `torchlayers-nightly-1685059622/tests/convolution_test.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/tests/general_test.py` & `torchlayers-nightly-1685059622/tests/general_test.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/tests/jit_test.py` & `torchlayers-nightly-1685059622/tests/jit_test.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/tests/pickle_test.py` & `torchlayers-nightly-1685059622/tests/pickle_test.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/tests/preprocessing_test.py` & `torchlayers-nightly-1685059622/tests/preprocessing_test.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/tests/regularization_test.py` & `torchlayers-nightly-1685059622/tests/regularization_test.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/tests/torchlayers_test.py` & `torchlayers-nightly-1685059622/tests/torchlayers_test.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/__init__.py` & `torchlayers-nightly-1685059622/torchlayers/__init__.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/_dev_utils/helpers.py` & `torchlayers-nightly-1685059622/torchlayers/_dev_utils/helpers.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/_dev_utils/infer.py` & `torchlayers-nightly-1685059622/torchlayers/_dev_utils/infer.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/activations.py` & `torchlayers-nightly-1685059622/torchlayers/activations.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/convolution.py` & `torchlayers-nightly-1685059622/torchlayers/convolution.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/module.py` & `torchlayers-nightly-1685059622/torchlayers/module.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/normalization.py` & `torchlayers-nightly-1685059622/torchlayers/normalization.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/pooling.py` & `torchlayers-nightly-1685059622/torchlayers/pooling.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/preprocessing.py` & `torchlayers-nightly-1685059622/torchlayers/preprocessing.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/regularization.py` & `torchlayers-nightly-1685059622/torchlayers/regularization.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers/upsample.py` & `torchlayers-nightly-1685059622/torchlayers/upsample.py`

 * *Files identical despite different names*

### Comparing `torchlayers-nightly-1684973248/torchlayers_nightly.egg-info/PKG-INFO` & `torchlayers-nightly-1685059622/torchlayers_nightly.egg-info/PKG-INFO`
...
### Comparing `torchlayers-nightly-1684973248/torchlayers_nightly.egg-info/SOURCES.txt` & `torchlayers-nightly-1685059622/torchlayers_nightly.egg-info/SOURCES.txt`

# Comparing `tmp/chartfactor-4.1.7.tar.gz` & `tmp/chartfactor-4.1.8.tar.gz`
...
### Comparing `chartfactor-4.1.7/chartfactor/src/assets/css/style.css` & `chartfactor-4.1.8/chartfactor/src/assets/css/style.css`

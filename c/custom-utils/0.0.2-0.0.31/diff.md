# Comparing `tmp/custom-utils-0.0.2.tar.gz` & `tmp/custom-utils-0.0.31.tar.gz`
...
### Comparing `custom-utils-0.0.2/PKG-INFO` & `custom-utils-0.0.31/PKG-INFO`
...
### Comparing `custom-utils-0.0.2/custom_utils/connector/mysql.py` & `custom-utils-0.0.31/custom_utils/connector/mysql.py`
...
### Comparing `custom-utils-0.0.2/custom_utils/exceptions.py` & `custom-utils-0.0.31/custom_utils/exceptions.py`
...
### Comparing `custom-utils-0.0.2/setup.py` & `custom-utils-0.0.31/setup.py`

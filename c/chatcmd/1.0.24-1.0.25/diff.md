# Comparing `tmp/chatcmd-1.0.24.tar.gz` & `tmp/chatcmd-1.0.25.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "chatcmd-1.0.24.tar", last modified: Sat May 27 21:15:38 2023, max compression
+gzip compressed data, was "chatcmd-1.0.25.tar", last modified: Sat May 27 21:18:48 2023, max compression
```

## Comparing `chatcmd-1.0.24.tar` & `chatcmd-1.0.25.tar`

### file list

```diff
@@ -1,21 +1,21 @@
-drwxr-xr-x   0 user       (501) staff       (20)        0 2023-05-27 21:15:38.715636 chatcmd-1.0.24/
--rw-r--r--   0 user       (501) staff       (20)     1069 2023-05-15 17:18:35.000000 chatcmd-1.0.24/LICENSE
--rw-r--r--   0 user       (501) staff       (20)     5594 2023-05-27 21:15:38.715246 chatcmd-1.0.24/PKG-INFO
--rw-r--r--   0 user       (501) staff       (20)     3972 2023-05-27 21:15:18.000000 chatcmd-1.0.24/README.md
-drwxr-xr-x   0 user       (501) staff       (20)        0 2023-05-27 21:15:38.712291 chatcmd-1.0.24/chatcmd/
--rw-r--r--   0 user       (501) staff       (20)        0 2023-04-26 12:02:06.000000 chatcmd-1.0.24/chatcmd/__init__.py
--rw-r--r--   0 user       (501) staff       (20)     1760 2023-05-27 20:45:29.000000 chatcmd-1.0.24/chatcmd/api.py
--rw-r--r--   0 user       (501) staff       (20)     3464 2023-05-27 21:15:18.000000 chatcmd-1.0.24/chatcmd/chatcmd.py
--rw-r--r--   0 user       (501) staff       (20)     3754 2023-05-27 21:02:39.000000 chatcmd-1.0.24/chatcmd/commands.py
--rw-r--r--   0 user       (501) staff       (20)     2373 2023-05-27 21:05:11.000000 chatcmd-1.0.24/chatcmd/helpers.py
--rw-r--r--   0 user       (501) staff       (20)     2640 2023-05-27 21:14:56.000000 chatcmd-1.0.24/chatcmd/lookup.py
-drwxr-xr-x   0 user       (501) staff       (20)        0 2023-05-27 21:15:38.714815 chatcmd-1.0.24/chatcmd.egg-info/
--rw-r--r--   0 user       (501) staff       (20)     5594 2023-05-27 21:15:38.000000 chatcmd-1.0.24/chatcmd.egg-info/PKG-INFO
--rw-r--r--   0 user       (501) staff       (20)      340 2023-05-27 21:15:38.000000 chatcmd-1.0.24/chatcmd.egg-info/SOURCES.txt
--rw-r--r--   0 user       (501) staff       (20)        1 2023-05-27 21:15:38.000000 chatcmd-1.0.24/chatcmd.egg-info/dependency_links.txt
--rw-r--r--   0 user       (501) staff       (20)       49 2023-05-27 21:15:38.000000 chatcmd-1.0.24/chatcmd.egg-info/entry_points.txt
--rw-r--r--   0 user       (501) staff       (20)       44 2023-05-27 21:15:38.000000 chatcmd-1.0.24/chatcmd.egg-info/requires.txt
--rw-r--r--   0 user       (501) staff       (20)        8 2023-05-27 21:15:38.000000 chatcmd-1.0.24/chatcmd.egg-info/top_level.txt
--rw-r--r--   0 user       (501) staff       (20)     1795 2023-05-27 21:15:18.000000 chatcmd-1.0.24/pyproject.toml
--rw-r--r--   0 user       (501) staff       (20)       38 2023-05-27 21:15:38.715739 chatcmd-1.0.24/setup.cfg
--rw-r--r--   0 user       (501) staff       (20)      556 2023-05-27 21:15:18.000000 chatcmd-1.0.24/setup.py
...
### Comparing `chatcmd-1.0.24/LICENSE` & `chatcmd-1.0.25/LICENSE`

 * *Files identical despite different names*

### Comparing `chatcmd-1.0.24/PKG-INFO` & `chatcmd-1.0.25/PKG-INFO`
...
@@ -65,17 +65,17 @@
 ...
 Installation output should display:
     ...
     Collecting chatcmd
-    Using cached chatcmd-1.0.24-py3-none-any.whl (6.8 kB)
+    Using cached chatcmd-1.0.25-py3-none-any.whl (6.8 kB)
     Installing collected packages: chatcmd
-    Successfully installed chatcmd-1.0.24
...
### Comparing `chatcmd-1.0.24/README.md` & `chatcmd-1.0.25/README.md`
...
### Comparing `chatcmd-1.0.24/chatcmd/api.py` & `chatcmd-1.0.25/chatcmd/api.py`

 * *Files identical despite different names*

### Comparing `chatcmd-1.0.24/chatcmd/chatcmd.py` & `chatcmd-1.0.25/chatcmd/chatcmd.py`
...
@@ -52,15 +52,15 @@
         ...
         if args['--version']:
-            print(color_text('ChatCMD','green')+' 1.0.24')
...
### Comparing `chatcmd-1.0.24/chatcmd/commands.py` & `chatcmd-1.0.25/chatcmd/commands.py`

 * *Files identical despite different names*

### Comparing `chatcmd-1.0.24/chatcmd/helpers.py` & `chatcmd-1.0.25/chatcmd/helpers.py`

 * *Files identical despite different names*

### Comparing `chatcmd-1.0.24/chatcmd/lookup.py` & `chatcmd-1.0.25/chatcmd/lookup.py`
...
### Comparing `chatcmd-1.0.24/chatcmd.egg-info/PKG-INFO` & `chatcmd-1.0.25/chatcmd.egg-info/PKG-INFO`
...
### Comparing `chatcmd-1.0.24/pyproject.toml` & `chatcmd-1.0.25/pyproject.toml`
...
### Comparing `chatcmd-1.0.24/setup.py` & `chatcmd-1.0.25/setup.py`

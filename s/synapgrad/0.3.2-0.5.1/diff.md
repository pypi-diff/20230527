# Comparing `tmp/synapgrad-0.3.2-py3-none-any.whl.zip` & `tmp/synapgrad-0.5.1-py3-none-any.whl.zip`
...
-Filename: synapgrad/utils/data.py
+Filename: synapgrad/optim/optimizers.py
 Comment: 
...
## Comparing `synapgrad/utils/data.py` & `synapgrad/nn/utils/data.py`
...
## Comparing `synapgrad/utils/graph.py` & `synapgrad/visual/graph.py`
...
## Comparing `synapgrad/utils/train.py` & `synapgrad/nn/utils/train.py`

 * *Files identical despite different names*

## Comparing `synapgrad-0.3.2.dist-info/LICENSE` & `synapgrad-0.5.1.dist-info/LICENSE`

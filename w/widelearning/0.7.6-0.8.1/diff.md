# Comparing `tmp/widelearning-0.7.6.tar.gz` & `tmp/widelearning-0.8.1.tar.gz`
...
## Comparing `widelearning-0.7.6.tar` & `widelearning-0.8.1.tar`
...
### Comparing `widelearning-0.7.6/widelearning.py` & `widelearning-0.8.1/widelearning.py`
